...
namespace BrushlessDCMotorSimulation
{
    public static class SimulationConstants
    {
        ...
        public const double SaturationCurrent = 8.0; // Amps
        public const double MinInductance = 0.0005; // Henries

        // Cogging torque parameters
        public const double CoggingTorqueAmplitude = 0.005; // Nm
        public const int SlotsPerPole = 12;

        // Ripple torque parameters
        public const double RippleTorqueAmplitude = 0.01; // Nm
        public const int RippleHarmonicOrder = 6;

        // FOC parameters
        public const double BaseSpeedRpm = SupplyVoltage / (BackEmfConstant * 2 * Math.PI / 60.0); // RPM
        public const double MaxVoltageUtilization = 0.95; // Fraction of DC link voltage
    }
}