...
namespace BrushlessDCMotorSimulation
{
    ...
    public class BLDCMotor
    {
        ...
        public void ApplyVoltages(double[] voltages, double deltaTime)
        {
            ...
            // Calculate effective inductance due to magnetic saturation
            ...
            double effectiveInductance = SimulationConstants.MinInductance +
            ...
            if (shortCircuitPhases.HasValue)
            {
                ...
                phaseCurrents[p2] = -phaseCurrents[p1]; // Fixed: Corrected typo
            }
        ...
        {
            // Cogging torque: sinusoidal function of rotor angle
            double angleRad = RotorAngle * Math.PI / 180.0;
            double frequency = SimulationConstants.SlotsPerPole; // Cogging frequency related to stator slots
            return SimulationConstants.CoggingTorqueAmplitude * Math.Sin(frequency * angleRad);
        }

        public double GetRippleTorque()
        {
            // Ripple torque: harmonic component proportional to current and angle
            double angleRad = RotorAngle * Math.PI / 180.0;
