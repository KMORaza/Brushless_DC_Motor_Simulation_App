namespace BrushlessDCMotorSimulation
{
    public static class SimulationConstants
    {
        ...
        public const double MutualInductance = 0.001; // Henries (nominal)
        ...
        public const double SaturationCurrent = 8.0; // Amps, current at which saturation becomes significant
        public const double MinInductance = 0.0005; // Henries, minimum inductance at full saturation

        // Cogging torque parameters
        public const double CoggingTorqueAmplitude = 0.005; // Nm
        public const int SlotsPerPole = 12; // Number of stator slots per pole, affects cogging frequency

        // Ripple torque parameters
        public const double RippleTorqueAmplitude = 0.01; // Nm, base amplitude of ripple torque
        public const int RippleHarmonicOrder = 6; // 6th harmonic for typical BLDC ripple
    }
}